                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="{{{URL::asset('template/images/icon/majoo_icon.png')}}}" width="60" height="auto" alt="Cool Admin" />
                                <img src="{{{URL::asset('template/images/icon/majoo_text.png')}}}" width="150" height="auto" alt="Cool Admin" />
                                {{-- <h3>
                                    LOGIN SISTEM POS
                                </h3> --}}
                            </a>
